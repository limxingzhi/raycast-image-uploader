...
const MAGIC: Array<{ mime: string; match: (h: Uint8Array) => boolean }> = [
  ...
  { mime: "image/heic", match: (h) => h[4] === 0x66 && h[5] === 0x74 && h[6] === 0x79 && h[7] === 0x70 && h[8] === 0x68 && h[9] === 0x65 && h[10] === 0x69 && h[11] === 0x63 },
  { mime: "image/avif", match: (h) => h[4] === 0x66 && h[5] === 0x74 && h[6] === 0x79 && h[7] === 0x70 && h[8] === 0x61 && h[9] === 0x76 && h[10] === 0x69 && h[11] === 0x66 },
  ...
  { mime: "video/mp4", match: (h) => h[4] === 0x66 && h[5] === 0x74 && h[6] === 0x79 && h[7] === 0x70 },
];
